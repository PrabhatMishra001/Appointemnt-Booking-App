...
const Home = () => {
  return <>
  <section className='hero_section pt-[60px] 2xl:h-[8000]px '>
        ...
        <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] lg:mt-[55px] ">
                <div className="py-[30px] px-5 ">
                    <div className="flex items-center justify-center "><img src={icon01} alt="" className="" /></div>

                    <div className="mt-[30px] ">
                        <h2 className="text-[26px] leading-9 text-headingColor font-[700] text-center ">Find a Doctor</h2>
                        <p className="text-[16px] leading-9 text-headingColor font-[400] mt-4 text-center ">World-class care for everyone. Our health Systems offers unmatched, expert health care. From the lab to the clinic </p>
                 ...
                 <div className="py-[30px] px-5 ">
                    <div className="flex items-center justify-center "><img src={icon02} alt="" className="" /></div>
                 ...
                 <div className="py-[30px] px-5 ">
                    <div className="flex items-center justify-center "><img src={icon03} alt="" className="" /></div>

                    <div className="mt-[30px] ">
                        <h2 className="text-[26px] leading-9 text-headingColor font-[700] text-center ">Book A Appointments</h2>
                        <p className="text-[16px] leading-9 text-headingColor font-[400] mt-4 text-center ">World-class care for everyone. Our health Systems offers unmatched, expert health care. From the lab to the clinic </p>
                        <Link to="/doctors" className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none '>
                        <BsArrowRight className="group-hover:textwhite w-6 h-5"/>
                        </Link>
                ...
                <section>
                    <div className="container">
                        <div className="xl:w-[470px] mx-auto ">
                            ...
                            <p className="text_para text_center">World-class care for everyone.Our health System offers unmatched,expert health care</p>
                        </div>
                ...
                <section>
                    <div className="container">
                        <div className="flex justify-between gap-[50px] lg:gap-0 ">
                            <div className="w-1/2 hidden md:block"><img src={faqImg} alt="" className="" /></div>
