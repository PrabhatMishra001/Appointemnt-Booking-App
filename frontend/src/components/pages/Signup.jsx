        ...
        <section className="px-5 xl:px-0">
            <div className="max-w-[1170px] mx-auto ">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="rounded-l-lg lg lg:pl-16 py-10">
                           ...
                           <form onSubmit={handleSignup}> 
                            ...
                            <div className="mb-5 flex items-center justify-between">
                                <label htmlFor="role" className='text-headingColor font-bold text-[15px] leading-7 '> Are you a:
                                    <select name="role" value={formData.role} onChange={handleInputChange} className='text-textColor font-semibold text-[15px] px-4 py-3 focus:outline-none '>
