...
const socialLinks=[
  {
    path:"https://www.youtube.com/@prabhatmishra2472/featured",
    icon:<AiFillYoutube className='group-hover:text-white w-4 h-5'/>
  },
  {
    path:"https://github.com/Prabhanavi",
  ...
  {
    path:"https://www.instagram.com/prabhat_narayan_mishra/",
    icon:<AiOutlineInstagram className='group-hover:text-white w-4 h-5'/>
  },

  {
    path:"https://www.linkedin.com/in/prabhat-mishra-474a95228/",
