                        ...
                        {tab === 'overview' && data && (
                            <div>
                                <div className='flex items-center gap-4 mb-10'>
                                    ...
                                    <div>
                                        <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-4 lg:py-2 lg:px-6 rounded text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold'>{data.specialization}</span>
                                        <h3 className='text-[22px] leading-9 font-bold text-headingColor mt-3'>{data.name}</h3>
                                        <div className='flex items-center gap-[6px]'>
                                            <span className='flex items-center gap-[6px] text-[14px] leading-6 lg:text-[16px] font-semibold text-headingColor'> <img src={starIcon} alt=''/>{data.averageRating}</span>
                                            <span className='text-headingColor text-[14px] leading-5 lg:text-[16px] lg:leading-6 font-semibold'>{data.totalRating}</span>
                                        </div>
